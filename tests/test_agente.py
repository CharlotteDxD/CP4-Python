...
def test_post_sem_categoria_chama_ia_e_grava():
    ...
    with patch(
        ...
        with patch(
            "app.blueprints.transacoes.transacoes_routes.gerar_recomendacao",
            return_value="Adie o pagamento",
        ):
            resp = client.post(
                "/transacoes",
                json={
